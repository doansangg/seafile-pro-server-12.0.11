...
class SeafServerThreadedRpcClient(NamedPipeClient):
    ...
    def seafile_create_repo(name, desc, owner_email, passwd, enc_version, storage_id, pwd_hash_algo, pwd_hash_params):
        pass
    create_repo = seafile_create_repo

    @searpc_func("string", ["string", "string", "string", "string", "string", "string", "string", "int", "string", "string", "string", "string"])
    def seafile_create_enc_repo(repo_id, name, desc, owner_email, magic, random_key, salt, enc_version, storage_id, pwd_hash, pwd_hash_algo, pwd_hash_params):
        pass
    ...
    def seafile_list_org_repo_sync_errors(start, limit):
        pass
    list_org_repo_sync_errors = seafile_list_org_repo_sync_errors

    @searpc_func("int", ["int"])
    def seafile_clear_org_repo_sync_errors():
        pass
    clear_org_repo_sync_errors = seafile_clear_org_repo_sync_errors
    ...
    @searpc_func("objlist", ["int"])
    def seafile_list_org_user_quota_usage(org_id):
        pass
    list_org_user_quota_usage = seafile_list_org_user_quota_usage
    ...
    @searpc_func("int64", ["int"])
    def get_org_user_default_quota(org_id):
        pass

    @searpc_func("int", ["int", "int64"])
    def set_org_user_default_quota(org_id, quota):
        pass
    ...
    # checkit if dir is downloadable
    @searpc_func("string", ["string", "string", "string", "string"])
    def seafile_is_dir_downloadable (repo_id, dir_path, user, repo_perm):
        pass
    is_dir_downloadable = seafile_is_dir_downloadable

    # org repo
    @searpc_func("string", ["string", "string", "string", "int", "string", "int", "string", "string"])
    def seafile_create_org_repo(name, desc, user, org_id, passwd, enc_version, pwd_hash_algo, pwd_hash_params):
        pass
    create_org_repo = seafile_create_org_repo

    @searpc_func("string", ["string", "string", "string", "string", "string", "string", "int", "int", "string", "string", "string"])
    def seafile_create_org_enc_repo(name, desc, user, passwd, magic, random_key, salt, enc_version, org_id, pwd_hash, pwd_hash_algo, pwd_hash_params):
        pass
    ...
    @searpc_func("objlist", ["int", "int", "int", "string", "int"])
    def seafile_get_org_repo_list(org_id, start, limit, order_by, ret_virt_repo):
        pass
    ...
    @searpc_func("int", ["int", "string"])
    def org_set_file_ext_white_list(org_id, white_list):
        pass

    @searpc_func("string", ["int"])
    def org_get_file_ext_white_list(org_id):
        pass

    @searpc_func("int", ["int"])
    def org_del_file_ext_white_list(org_id):
        pass
    ...
    @searpc_func("int", ["string", "string"])
    def update_repo_storage_id(repo_id, storage_id):
        pass
    ...
    @searpc_func("int", ["string", "int", "string"])
    def transfer_group_repo_to_user (repo_id, group_id, user):
        pass

    @searpc_func("string", ["int", "string", "string", "string", "int", "string", "string", "string"])
    def add_group_owned_repo(group_id, name, permission, passwd, enc_version, storage_id, pwd_hash_algo, pwd_hash_params):
        pass
    ...
    @searpc_func("int", ["int", "string", "int", "string"])
    def org_transfer_group_repo_to_user (org_id, repo_id, group_id, user):
        pass

    @searpc_func("string", ["int", "int", "string", "string", "string", "string", "int", "string", "string"])
    def org_add_group_owned_repo(org_id, group_id, name, permission, passwd, enc_version, pwd_hash_algo, pwd_hash_params):
        pass
    ...
    @searpc_func("int", ["string", "string"])
    def set_repo_type(repo_id, repo_type):
        pass
    ...
    @searpc_func("objlist", ["int", "string", "int", "int"])
    def search_org_users(self, org_id, email_patt, start, limit):
        pass

    @searpc_func("objlist", ["int", "string", "int", "int"])
    def search_org_groups(self, org_id, group_patt, start, limit):
        pass
    ...
    @searpc_func("objlist", ["string", "int", "int"])
    def get_org_groups_by_user (self, user, org_id, return_ancestors):
        pass
