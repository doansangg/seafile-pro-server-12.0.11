/* seafile-object.h generated by valac 0.48.6, the Vala compiler, do not modify */
...
void seafile_repo_set_status (SeafileRepo* self,
                              gint value);
const gchar* seafile_repo_get_repo_type (SeafileRepo* self);
void seafile_repo_set_repo_type (SeafileRepo* self,
                                 const gchar* value);
...
void seafile_repo_set_salt (SeafileRepo* self,
                            const gchar* value);
const gchar* seafile_repo_get_pwd_hash (SeafileRepo* self);
void seafile_repo_set_pwd_hash (SeafileRepo* self,
                                const gchar* value);
const gchar* seafile_repo_get_pwd_hash_algo (SeafileRepo* self);
void seafile_repo_set_pwd_hash_algo (SeafileRepo* self,
                                     const gchar* value);
const gchar* seafile_repo_get_pwd_hash_params (SeafileRepo* self);
void seafile_repo_set_pwd_hash_params (SeafileRepo* self,
                                       const gchar* value);
...
void seafile_encryption_info_set_pwd_hash (SeafileEncryptionInfo* self,
                                           const gchar* value);
const gchar* seafile_encryption_info_get_pwd_hash_algo (SeafileEncryptionInfo* self);
void seafile_encryption_info_set_pwd_hash_algo (SeafileEncryptionInfo* self,
                                                const gchar* value);
const gchar* seafile_encryption_info_get_pwd_hash_params (SeafileEncryptionInfo* self);
void seafile_encryption_info_set_pwd_hash_params (SeafileEncryptionInfo* self,
                                                  const gchar* value);
...
void seafile_dirent_set_lock_time (SeafileDirent* self,
                                   gint64 value);
gint64 seafile_dirent_get_expire (SeafileDirent* self);
void seafile_dirent_set_expire (SeafileDirent* self,
                                gint64 value);
...
void seafile_web_access_set_check_virus (SeafileWebAccess* self,
                                         gint value);
GType seafile_share_link_info_get_type (void) G_GNUC_CONST;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (SeafileShareLinkInfo, g_object_unref)
SeafileShareLinkInfo* seafile_share_link_info_new (void);
SeafileShareLinkInfo* seafile_share_link_info_construct (GType object_type);
const gchar* seafile_share_link_info_get_repo_id (SeafileShareLinkInfo* self);
void seafile_share_link_info_set_repo_id (SeafileShareLinkInfo* self,
                                          const gchar* value);
const gchar* seafile_share_link_info_get_file_path (SeafileShareLinkInfo* self);
void seafile_share_link_info_set_file_path (SeafileShareLinkInfo* self,
                                            const gchar* value);
const gchar* seafile_share_link_info_get_parent_dir (SeafileShareLinkInfo* self);
void seafile_share_link_info_set_parent_dir (SeafileShareLinkInfo* self,
                                             const gchar* value);
const gchar* seafile_share_link_info_get_share_type (SeafileShareLinkInfo* self);
void seafile_share_link_info_set_share_type (SeafileShareLinkInfo* self,
                                             const gchar* value);
