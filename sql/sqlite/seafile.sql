...
CREATE TABLE IF NOT EXISTS RoleDownloadLimit (role TEXT, download_limit BIGINT);
CREATE TABLE IF NOT EXISTS RoleUploadLimit (role TEXT, upload_limit BIGINT);

CREATE TABLE IF NOT EXISTS UserDownloadLimit (user TEXT, download_limit BIGINT);
CREATE TABLE IF NOT EXISTS UserUploadLimit (user TEXT, upload_limit BIGINT);
CREATE TABLE IF NOT EXISTS OrgUserDefaultQuota (org_id INTEGER, quota BIGINT, PRIMARY KEY (org_id));
CREATE TABLE IF NOT EXISTS OrgDownloadRateLimit (org_id INTEGER, download_limit BIGINT);
CREATE TABLE IF NOT EXISTS OrgUploadRateLimit (org_id INTEGER, upload_limit BIGINT);
